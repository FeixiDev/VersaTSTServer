...
class UpdateYaml(object):
    def __init__(self,flie_path):
        self.file_path = flie_path

    def update_spof_scenario(self):
        file_path1 = sys.path[0] + self.file_path
    ...
    def update_spof_pvc_scenario(self):
        file_path2 = sys.path[0] + self.file_path
