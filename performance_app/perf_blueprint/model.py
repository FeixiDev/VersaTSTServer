    ...
    def post(self):
        if request.method == 'POST':
            ...
            if spof_scenario_yaml.filename != '':
                spof_scenario_yaml.save(os.path.join(sys.path[0] + '/upload_file_fun', spof_scenario_yaml.filename))
                file_path = os.path.join(sys.path[0] + '/upload_file_fun', spof_scenario_yaml.filename)
                data_processing.update_spof_scenario(file_path)
                return cors_data('SUCCESS')
    ...
    def post(self):
        if request.method == 'POST':
            ...
            if spof_pvc_scenario_yaml.filename != '':
                spof_pvc_scenario_yaml.save(
                    os.path.join(sys.path[0] + '/upload_file_fun', spof_pvc_scenario_yaml.filename))
                file_path = os.path.join(sys.path[0] + '/upload_file_fun', spof_pvc_scenario_yaml.filename)
                data_processing.update_spof_pvc_scenario(file_path)
                return cors_data('SUCCESS')
    ...
    def post(self):
        if request.method == 'POST':
            ...
            if self_defined_scenario_yaml.filename != '':
                self_defined_scenario_yaml.save(
                    os.path.join(sys.path[0] + '/upload_file_fun', self_defined_scenario_yaml.filename))
                return cors_data('SUCCESS')
    ...
    def post(self):
        if request.method == 'POST':
            ...
            if video_scenario_yaml.filename != '':
                video_scenario_yaml.save(os.path.join(sys.path[0] + '/upload_file_fun', video_scenario_yaml.filename))
                return cors_data('SUCCESS')
    ...
    def post(self):
        if request.method == 'POST':
            ...
            if Seq_rw_scenario_yaml.filename != '':
                Seq_rw_scenario_yaml.save(os.path.join(sys.path[0] + '/upload_file_fun', Seq_rw_scenario_yaml.filename))
                return cors_data('SUCCESS')
    ...
    def post(self):
        if request.method == 'POST':
            ...
            if random_rw_scenario_yaml.filename != '':
                random_rw_scenario_yaml.save(
                    os.path.join(sys.path[0] + '/upload_file_fun', random_rw_scenario_yaml.filename))
                return cors_data('SUCCESS')
