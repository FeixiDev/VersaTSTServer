...
per_blueprint.add_url_rule('/reliability/spof/create', view_func=model.spofCreate.as_view('spof'))
...
per_blueprint.add_url_rule('/reliability/spof/upload', view_func=model.spofScenarioUpload.as_view('spof-upload'),methods =['POST'])
per_blueprint.add_url_rule('/reliability/spof-pvc/upload', view_func=model.spofpvcScenarioUpload.as_view('spof-pvc-upload'),methods =['POST'])

per_blueprint.add_url_rule('/performance/self-defined/upload', view_func=model.selfdefinedScenarioUpload.as_view('self-defined-upload'),methods =['POST'])
per_blueprint.add_url_rule('/performance/seq-rw/upload', view_func=model.seqrwScenarioUpload.as_view('seq-rw-upload'),methods =['POST'])
per_blueprint.add_url_rule('/performance/video/upload', view_func=model.videoScenarioUpload.as_view('video-upload'),methods =['POST'])
per_blueprint.add_url_rule('/performance/random-rw/upload', view_func=model.randomrwScenarioUpload.as_view('random-rw-upload'),methods =['POST'])
