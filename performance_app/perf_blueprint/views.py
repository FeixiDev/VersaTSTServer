...
per_blueprint.add_url_rule('/reliability/spof/upload', view_func=model.spofScenarioUpload.as_view('random-rw-upload'))
per_blueprint.add_url_rule('/reliability/spof-pvc/upload', view_func=model.spofpvcScenarioUpload.as_view('spof-pvc-upload'))

per_blueprint.add_url_rule('/performance/self-defined/upload', view_func=model.spofScenarioUpload.as_view('self-defined-upload'))
